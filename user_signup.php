...
<body>
    ...
    <main>
        <div class="h1-container">
            <h1>End-Users Registration Form</h1>
        </div>
        <div class="form-container">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="row">
                        <label class="label">Are you living in Hong Kong?</label>
                        <div class="input-container">
                            <input type="radio" class="radio-button" id="hongkong_resident_yes" name="hongkong_resident" value="yes">
                            <input type="radio" class="radio-button" id="hongkong_resident_no" name="hongkong_resident" value="no">
                            <label for="hongkong_resident_yes" class="radio-button-label" id="yesLabel">Yes</label>
                            <label for="hongkong_resident_no" class="radio-button-label" id="noLabel">No</label>
                        </div>
                    </div>
                </div>
                <script>
                    ...
                    document.addEventListener('DOMContentLoaded', function () {
                        const yesButton = document.getElementById('hongkong_resident_yes');
                        const noButton = document.getElementById('hongkong_resident_no');
